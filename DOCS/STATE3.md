...
| **Current task** | **T206** — `fengdong/widgets.py`: the closed widget set, unit-tested headless |
| **Task status** | `not_started` — T205 closed in session 28 with every acceptance criterion run and passed, and the full fourteen-rung ladder re-run on both backends |
| **Completed tasks** | Phase 0: T001 … T011, all eleven. Phase 1: T101 … T110, all ten. Phase 2: **T201**, **T202**, **T203**, **T204**, **T205** |
